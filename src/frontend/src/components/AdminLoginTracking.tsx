...
export default function AdminLoginTracking() {
  ...
  const getRoleBadgeColor = (role: string) => {
    if (
      role.toLowerCase().includes("expert") ||
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              disabled={
                downloadCSVMutation.isPending || loginEvents.length === 0
              }
            ...
            <Table>
              ...
              <TableBody>
                {loginEvents.map((event, index) => (
                  <TableRow
                    // biome-ignore lint/suspicious/noArrayIndexKey: login events have no stable ID
                    key={index}
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge
                        className={`${getRoleBadgeColor(event.role)} text-white shadow-sm`}
                      >
                        {event.role}
                      </Badge>
                    </TableCell>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-800 dark:text-blue-200">
                Download login tracking data as a CSV file for offline analysis
