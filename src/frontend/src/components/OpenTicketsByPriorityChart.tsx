...
export default function OpenTicketsByPriorityChart({
  openTickets,
  totalTickets: _totalTickets,
}: OpenTicketsByPriorityChartProps) {
  ...
  const data = [
    ...
    {
      priority: "Critical",
      count: Math.max(0, openTickets - base * 3),
      color: "#ef4444",
    },
  ];
          ...
          >
            ...
            <Bar dataKey="count" radius={[4, 4, 0, 0]}>
              {data.map((entry, index) => (
                // biome-ignore lint/suspicious/noArrayIndexKey: chart data index is stable
