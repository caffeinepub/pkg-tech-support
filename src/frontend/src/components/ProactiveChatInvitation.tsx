...
export default function ProactiveChatInvitation({
  onAccept,
  onDismiss,
}: ProactiveChatInvitationProps) {
  return (
    <div
      className="animate-scale-in rounded-2xl shadow-modal border border-primary/30 overflow-hidden"
