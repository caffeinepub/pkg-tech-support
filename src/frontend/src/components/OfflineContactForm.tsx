...
export default function OfflineContactForm({
  ...
  if (submitted) {
    return (
      <div
        className="rounded-2xl border-2 p-8 text-center shadow-modal"
  ...
  return (
    <div
      className="rounded-2xl border-2 shadow-modal overflow-hidden"
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm opacity-90">
            All experts are currently offline
          </p>
        </div>
      </div>
