...
const pricingTiers = [
  ...
  },
  {
    ...
    price: "₹1,500",
    description:
      "Complete repair & optimization for laptops or mobile devices.",
    color: "var(--secondary)",
...
const testimonials = [
  ...
  {
    quote:
      "Laptop running smooth again — couldn't believe how fast the fix was!",
    name: "Priya M.",
    location: "Delhi",
    rating: 5,
  },
  {
    quote:
      "Phone screen replaced same day! Highly recommend for mobile repairs.",
    name: "Amit K.",
    location: "Jaipur",
    rating: 5,
  },
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, oklch(0.15 0.05 195 / 0.72) 0%, oklch(0.15 0.05 265 / 0.72) 100%)",
          }}
        >
          <h2
          ...
          <p
            className="mt-3 text-base md:text-lg font-medium text-center px-4"
        ...
        <div className="relative max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          >
            ...
            <span style={{ color: "var(--primary)" }}>
              Fast Fixes for Laptops, Desktops, Mobiles & Printers
            </span>{" "}
            | 10+ Years Experience
          </h1>
          ...
          <p
            ...
            style={{ color: "var(--muted-foreground)" }}
          >
            Jaipur-based pro fixing your laptops, desktops, mobiles, and
            printers remotely or on-site. Quick, affordable solutions for
            home/office.{" "}
            <span className="font-semibold" style={{ color: "var(--primary)" }}>
              Message for same-day help!
            </span>
          </p>
              ...
              >
                ...
                <div className="flex items-center gap-1 mb-1">
                  {Array.from({ length: t.rating }, (_, i) => (
                    <Star
                      // biome-ignore lint/suspicious/noArrayIndexKey: star count is deterministic
                      key={`star-${i}`}
