...
import { ArrowLeft, Calendar, Edit, Eye, Tag, Trash2 } from "lucide-react";
import React, { useEffect } from "react";
import type { KBArticle, KnowledgeCategory } from "../backend";
import {
  useDeleteKBArticle,
...
export default function KBArticleDetail({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: incrementView.mutate is stable
  useEffect(() => {
